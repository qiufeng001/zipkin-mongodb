...
public final class Access {
  ...
  public static void registerMongoDB(AnnotationConfigApplicationContext context) {
    context.register(
      PropertyPlaceholderAutoConfiguration.class, ZipkinMongoDBStorageAutoConfiguration.class);
  }
}
